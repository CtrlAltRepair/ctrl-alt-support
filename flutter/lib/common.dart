...
class MyTheme {
  ...
  static const Color accent = Color(0xFFFF4100);
  static const Color accent50 = Color(0x77FF4100);
  static const Color accent80 = Color(0xAAFF4100);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
        primary: const Color(0xFFFF4100), secondary: accent, background: grayBg),
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://ctrlaltrepair.com'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
